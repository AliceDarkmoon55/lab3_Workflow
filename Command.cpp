...
void Read::execute() {
    if (args.empty()) {
        throw NoParameterException("readfile");
    }
...
void Write::execute() {
    if (args.empty()) {
        throw NoParameterException("writefile");
    }
...
void Grep::execute() {
    if (args.empty()) {
        throw NoParameterException("grep");
    }
...
void Replace::execute() {
    if (args.empty()) {
        throw NoParameterException("replace");
    }
    std::string arg1;
    arg1 = args.front();
...
void Dump::execute() {
    if (args.empty()) {
        throw NoParameterException("dump");
    }
